...
const S = {
  ...
  daqiqaQisqa: ["daq", "мин"],
  kattalarDtm: ["DTM tayyorgarlik", "Подготовка к ДТМ"],
  kattalarDtmIzoh: ["30 savol, 60 daqiqa, xato tahlili", "30 вопросов, 60 минут, разбор ошибок"],
  ...
  anketaKattalar: ["Boshqa — o'zim uchun", "Другое — для себя"],
