...
const S = {
  ...
  bugunKunlikSonQisqa: ["Kunlik son", "Число дня"],
  bugunSavolSoni: ["{n} ta savol", "{n} вопросов"],
  bugunDarsdanKeyin: ["Darsdan keyin", "После урока"],
  bugunQoldi: ["{soat} qoldi", "осталось {soat}"],
