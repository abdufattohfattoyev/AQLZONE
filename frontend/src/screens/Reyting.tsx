 ...
 *
 * Ikki jadval, va ikkinchisi majburiy:
 *
 *   Jami       — butun vaqt bo'yicha. Uzoq o'ynagan bola yuqorida turadi.
 *   Shu hafta  — har dushanba noldan boshlanadi.
 *
 * Faqat "jami" bo'lganda jadval bir necha oydan keyin qotib qoladi: yangi
 * kelgan bola oldingilarni hech qachon quvib yeta olmaydi va reyting unga
 * ma'nosiz bo'lib qoladi. Haftalik jadval hammani teng sharoitga qo'yadi.
 *
 * O'z o'rning DOIM ko'rinadi — 100 talikka kirmasang, pastda alohida
 * qator bo'lib turadi. Ro'yxatda o'zini ko'rmagan bola uchun reyting
 * begona odamlar jadvaliga aylanadi.
 */
